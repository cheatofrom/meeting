...
# Using SSL certificates for secure WebSocket (wss://)
python funasr_wss_server.py --port 10095 --certfile /path/to/your/certificate.crt --keyfile /path/to/your/private.key

# Using local models
python funasr_wss_server.py --port 10095 \
  --asr_model /path/to/your/asr_model \
  --asr_model_online /path/to/your/asr_model_online \
  --vad_model /path/to/your/vad_model \
  --punc_model /path/to/your/punc_model
```
